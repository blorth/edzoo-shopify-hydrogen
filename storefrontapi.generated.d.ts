  ...
  products: {
    edges: Array<{
      ...
      > & {
        ...
        images: {
          nodes: Array<
            Pick<StorefrontAPI.Image, 'src' | 'height' | 'id' | 'url' | 'width'>
          >;
        };
        metaFieldProductType?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'id' | 'value'>
        >;
        metaFieldCohort?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'id' | 'value'>
        >;
        metaFieldPurchaseTypeTag?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'id' | 'value'>
        >;
      };
    }>;
...
export type GetMonthlyBoxesQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type GetMonthlyBoxesQuery = {
  products: {
    edges: Array<{
      node: Pick<
        StorefrontAPI.Product,
...
export type CollectionQueryQueryVariables = StorefrontAPI.Exact<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GetMonthlyBoxes {\n    products(\n      first: 20\n      query: "(id:7623752188076) OR (id:7658802774188) OR (id:7605196030124)"\n    ) {\n      edges {\n        node {\n          availableForSale\n          id\n          description\n          handle\n          productType\n          title\n          priceRange {\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n            minVariantPrice {\n              currencyCode\n              amount\n            }\n          }\n          featuredImage {\n            id\n            url\n            altText\n            width\n            height\n          }\n          images(first: 10) {\n            nodes {\n              id\n              url\n              altText\n              width\n              height\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GetMonthlyBoxesQuery;
    variables: GetMonthlyBoxesQueryVariables;
  };
  '#graphql\n  query CollectionQuery($collectionHandle: String!) {\n    collection(handle: $collectionHandle) {\n      ...Subscriptions\n    }\n  }\n  #graphql\n  fragment Subscriptions on Collection {\n    id\n    handle\n    products(first: 10) {\n      edges {\n        node {\n          availableForSale\n          id\n          description\n          handle\n          productType\n          title\n          priceRange {\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n            minVariantPrice {\n              currencyCode\n              amount\n            }\n          }\n          featuredImage {\n            id\n            url\n            altText\n            width\n            height\n          }\n          requiresSellingPlan\n          variants(first: 10) {\n            edges {\n              node {\n                id\n                compareAtPrice {\n                  amount\n                  currencyCode\n                }\n                currentlyNotInStock\n                price {\n                  amount\n                }\n              }\n            }\n          }\n          images(first: 10) {\n            nodes {\n              src\n              height\n              id\n              url\n              width\n            }\n          }\n          metaFieldProductType: metafield(key: "product_type", namespace: "filter") {\n            id\n            value\n        \t}\n          metaFieldCohort: metafield(key: "cohort", namespace: "custom") {\n            id\n            value\n        \t}\n          metaFieldPurchaseTypeTag: metafield(key: "purchase_type_tag", namespace: "custom") {\n            id\n            value\n        \t}\n        }\n      }\n    }\n  }\n\n': {
    return: CollectionQueryQuery;
    variables: CollectionQueryQueryVariables;
  };
}
